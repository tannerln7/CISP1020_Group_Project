...
public class CustomerFileDemo {
    ...
    public static void main(String[] args) {
        ...
        Customer customer = new Customer("Tuan Tran", "987-654-3210");
        Customer customer1 = new Customer("***REMOVED*** ***REMOVED***", "123-456-7890");
        RewardsCustomer rewardsCustomer = new RewardsCustomer("Tuan Tran", "987-654-3210", "email@email.com");
        RewardsCustomer rewardsCustomer1 = new RewardsCustomer("***REMOVED*** ***REMOVED***", "123-456-7890", "email@email.com");
